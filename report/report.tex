...
address the limitations of classic activation functions.
...
On the other hand, this observation comes with some caveats: the test data
sets are still rather small, and the neural networks tested have relatively
few parameters and layers.  As is usual with machine learning, it may be the
case that there exist differences only observable on larger datasets and
networks.
