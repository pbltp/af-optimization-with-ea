...
\item{Create a framework for evaluation of evolutionary algorithms.
Until: 03.06.2026}
...
\begin{itemize}
\item Research prior art/references: ...
\item Research possible (modern) activation functions: ...
\item Implement assignment of AFs to individual neurons in PyTorch: ...
\item Research/design a possible evolutionary algorithm (for AF optimization): ...
\item Implement the evolutionary algorithm in PyTorch: ...
\item Experiment with different evolutionary algorithms (?): ...
\item Charts: ...
\item Report, editing: ...
\end{itemize}
